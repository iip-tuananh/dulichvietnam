...
<section class="bread-crumb margin-bottom-10">
	...
	<ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
		...
		<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
			<strong itemprop="name">Contact Us</strong>
...
<div class="contact margin-bottom-20 page-contacts">
	<h1 class="title-head text-center d-none">Contact Us</h1>
	<div class="container">
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="contact-box">
						<div class="icon">
							...
							<path d="m96.144531 136v88h32v-56c0-4.417969 3.582031-8 8-8h48c4.417969 0 8 3.582031 8 8v56h32v-88c0-4.417969 3.582031-8 8-8h8.480469l-80.480469-61.902344-80.480469 61.902344h8.480469c4.417969 0 8 3.582031 8 8zm0 0" data-original="#000000" class="active-path" data-old_color="#000000" fill="#22B074"/>
							<path d="m144.144531 176h32v48h-32zm0 0" data-original="#000000" class="active-path" data-old_color="#000000" fill="#22B074"/>
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="contact-box">
						<div class="icon">
							...
							<path d="M403.954,77.8c-42.6-42.6-96.5-69.5-156-77.8l-5.2,37.1c51.4,7.2,98,30.5,134.8,67.2c34.9,34.9,57.8,79,66.1,127.5    l36.9-6.3C470.854,169.3,444.354,118.3,403.954,77.8z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#22B074"/>
							</svg>
						</div>
						<div class="content">
							<a href="tel:{{$setting->phone1}}" title="{{$setting->phone1}}">{{$setting->phone1}}</a> - 
							<a href="tel:{{$setting->phone2}}" title="{{$setting->phone2}}">{{$setting->phone2}}</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<fieldset class="form-group">
							...
							<input placeholder="Full name" type="text" name="name" id="name" class="form-control  form-control-lg"  data-validation="required" required />
						</fieldset>
					</div>
					<div class="col-sm-4 col-xs-12">
						<fieldset class="form-group">
							<label>Email<span class="required">*</span></label>
							<input placeholder="Email address" type="email" name="email" data-validation="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$"  id="email" class="form-control form-control-lg" required />
						</fieldset>
					</div>
					<div class="col-sm-4 col-xs-12">
						<fieldset class="form-group">
							<label>Phone<span class="required">*</span></label>
							<input placeholder="Phone number" type="tel" name="phone" data-validation="tel" id="tel" class="number-sidebar form-control form-control-lg" required />
						</fieldset>
					</div>
					<div class="col-sm-12 col-xs-12">
						<fieldset class="form-group">
							<label>Content<span class="required">*</span></label>
							<textarea placeholder="Content contact" name="mess" id="comment" class="form-control form-control-lg" rows="5" data-validation="required" required></textarea>
						</fieldset>
